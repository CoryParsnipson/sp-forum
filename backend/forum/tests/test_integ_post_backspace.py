...
class IntegPostBackspaceTests(StaticLiveServerTestCase):
    """
    ...
    def test_anonymous_user_post(self):
        ...
        EXP_TEST_STRING = 'Holy fuckin BULL shit'
        ...
        # go to middle of text, backspace, and then keep typing
        ActionChains(self.selenium) \
            .send_keys(TEST_STRING) \
            .send_keys(*[Keys.LEFT for i in range(5)]) \
            .send_keys(*[Keys.BACKSPACE for i in range(1)]) \
            .send_keys(" BULL") \
            .perform()
        ...
        self.assertEqual(EXP_TEST_STRING, new_post_content.text)
