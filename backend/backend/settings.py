...
MIDDLEWARE = [
    ...
    # Simplified static file serving (https://warehouse.python.org/project/whitenosie/)
...
if os.environ['SERVER_MODE'] == "development":
    DATABASES = {
        'default': {
...
elif os.environ['SERVER_MODE'] == "production":
    DATABASES = {
...
STATIC_ROOT = "/assets" if os.environ["SERVER_MODE"] == "production" else os.path.join(BASE_DIR, 'assets')
STATIC_URL = '/static/'
...
REST_FRAMEWORK = {
    # Default global access is restrictive (finer grained relaxations handled in DRF ViewSets)
